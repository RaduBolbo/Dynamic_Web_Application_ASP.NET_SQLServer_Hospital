...
namespace P3
{
    public partial class modificamedicament : System.Web.UI.Page
    {
        ...
        protected void Button_modifica_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox_denumire.Text.Length != 0)
            {
                ...
                list_of_modified_columns = list_of_modified_columns + "denumire = " + "'" + TextBox_denumire.Text + "'";
            }

            

            // creez diun timp textul pentru comanda
            String text_comanda = "UPDATE medicamente SET " + list_of_modified_columns + " WHERE medicamentid = " + selected_id + ";";
            ...
            try
            {
                ...
                Response.Redirect("medicamentmodificatcusucces.aspx");
            }
            catch (Exception ex)
            {
                // previne blocarea
        ...
        protected void TextBox_denumire_TextChanged(object sender, EventArgs e)
        {
