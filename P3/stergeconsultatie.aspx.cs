...
namespace P3
{
    public partial class stergeconsultatie : System.Web.UI.Page
    {
        ...
        protected void Button_sterge_Click(object sender, EventArgs e)
        {
            ...
            String text_comanda = "DELETE FROM consultatie WHERE consultatieid = " + selected_id + ";";
            ...
            try
            {
                ...
                Response.Redirect("consultatiestearsacusucces.aspx");
            }
            catch (Exception ex)
            {
                // previne blocarea
