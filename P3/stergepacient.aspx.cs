...
namespace P3
{
    public partial class stergepacient : System.Web.UI.Page
    {
        ...
        protected void Button_sterge_Click(object sender, EventArgs e)
        {
            ...
            String text_comanda = "DELETE FROM pacient WHERE pacientid = " + selected_id + ";";
            ...
            try
            {
                ...
                Response.Redirect("pacientsterscusucces.aspx");
            }
            catch (Exception ex)
            {
                // previne blocarea
