...
namespace P3
{
    public partial class stergemedic : System.Web.UI.Page
    {
        ...
        protected void Button_sterge_Click(object sender, EventArgs e)
        {
            ...
            String text_comanda = "DELETE FROM medic WHERE medicid = " + selected_id + ";";
            ...
            try
            {
                ...
                Response.Redirect("medicsterscusucces.aspx");
            }
            catch (Exception ex)
            {
                // previne blocarea
